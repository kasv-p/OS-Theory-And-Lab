               ...
               int cpu)
{
  ...
  // printing alloted time of each process, quantum used by the process and left quantum
  printf("Alloted Quantum is %d, Used Quantum is %d, Quantum Left to run on the CPU is %d\n", p->p_quantum_size_ms, p->p_quantum_size_ms - cpu_time_2_ms(p->p_cpu_time_left), cpu_time_2_ms(p->p_cpu_time_left));
